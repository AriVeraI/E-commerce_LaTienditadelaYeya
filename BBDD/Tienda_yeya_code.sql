...
-- Schema la_yeya
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `la_yeya` DEFAULT CHARACTER SET utf8 ;
USE `la_yeya` ;
...
CREATE TABLE IF NOT EXISTS `la_yeya`.`carrito` (
  ...
  CONSTRAINT `fk_carrito_carrito_productos1`
    ...
    REFERENCES `la_yeya`.`carrito_productos` (`id_carrito_productos`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `la_yeya`.`pedidos` (
  ...
  CONSTRAINT `fk_pedidos_usuarios1`
    ...
    REFERENCES `la_yeya`.`usuarios` (`id_usuario` , `carrito_id_carrito`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_pedidos_detalle_pedido1`
    FOREIGN KEY (`detalle_pedido_id_detalle_pedido`)
    REFERENCES `la_yeya`.`detalle_pedido` (`id_detalle_pedido`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `la_yeya`.`pagos` (
  ...
  CONSTRAINT `fk_pagos_pedidos1`
    ...
    REFERENCES `la_yeya`.`pedidos` (`id_pedidos` , `usuarios_id_usuario` , `usuarios_carrito_id_carrito` , `detalle_pedido_id_detalle_pedido`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
